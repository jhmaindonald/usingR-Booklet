...
The data set `MASS::Rubber` is from the accelerated testing of tyre 
...
### Other Choices of Contrasts
There are other ways to set up the X matrix that use other 
choices of contrasts.  One obvious alternative is to make 
...
```  
Another possibility is to use what are called the `sum` contrasts.  
